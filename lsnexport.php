...
$event = \mod_roshine\event\lesson_exported::create(array(
...
if (get_config('mod_roshine', 'lesson_export_filename')) {
...
$sqlc = "SELECT COUNT(mte.texttotype)
        FROM {roshine_lessons} mtl
        LEFT JOIN {roshine_exercises} mte
