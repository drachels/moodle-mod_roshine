...
/**
 * The mod_roshine lesson imported event.
 *
 * @package     mod_roshine
...
/**
 * The mod_roshine lesson imported event class.
 *
 * @package    mod_roshine
 * @copyright  2016 AL Rachels drachels@drachels.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class lesson_imported extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('lesson_imported', 'mod_roshine');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' imported a roshine lesson/category while in the course with id
