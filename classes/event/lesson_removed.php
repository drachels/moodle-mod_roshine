...
class lesson_removed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('lesson_removed', 'mod_roshine');
    }
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' removed a roshine lesson and all its exercises while in the course with id
