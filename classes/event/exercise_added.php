...
/**
 * The mod_roshine exercise added event.
 *
 * @package     mod_roshine
...
/**
 * The mod_roshine exercises added event class.
 *
 * @package    mod_roshine
 * @copyright  2016 AL Rachels drachels@drachels.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class exercise_added extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('exercise_added', 'mod_roshine');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' added a roshine exercise/category while in the course with id
