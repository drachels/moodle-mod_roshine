...
/**
 * The mod_roshine exercise edited event.
 *
 * @package     mod_roshine
...
/**
 * The mod_roshine exercises edited event class.
 *
 * @package    mod_roshine
 * @copyright  2016 AL Rachels drachels@drachels.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class exercise_edited extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('exercise_edited', 'mod_roshine');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' edited a roshine exercise while in the course with id
