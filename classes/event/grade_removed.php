...
/**
 * The mod_roshine grade removed event.
 *
 * @package     mod_roshine
...
/**
 * The mod_roshine grade removed event class.
 *
 * @package    mod_roshine
 * @copyright  2016 AL Rachels drachels@drachels.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class grade_removed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('grade_removed', 'mod_roshine');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' removed a roshine exercise grade while in the course with id
